...
import com.example.wrotter.adapters.AdaptadorJugador;
...
public class RankingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Utilidades.ordenarListaUsuarios();

        //        Utilidades.obtenerListaUsuarios(actividad);
        ranking= vista.findViewById(R.id.rvRanking);
        btInicio = vista.findViewById(R.id.btInicio);
        ...
        ranking.setLayoutManager(new LinearLayoutManager(this.actividad));
        ranking.setHasFixedSize(true);

        final AdaptadorJugador miAdaptador = new AdaptadorJugador(Utilidades.listaJugadores);
        ranking.setAdapter(miAdaptador);
